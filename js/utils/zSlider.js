...
(function(root, factory) {
    ...
    /**
     * defaults: Slideré»˜è®¤é…ç½®é¡¹
    */
    var defaults = {
        'current': 0, // åˆå§‹åŒ–æ—¶æ˜¾ç¤ºé¡¹index
        'duration': 0.8, // å•ä½ï¼šç§’
        'minPercentToSlide': null, // swipeè‡³å°‘å¤šå°‘è·ç¦»æ—¶è§¦å‘slide
        'autoplay': true, // æ˜¯å¦è‡ªåŠ¨è½®æ’­
        'direction': 'left', // è‡ªåŠ¨è½®æ’­æ–¹å‘
        'interval': 5 // å•ä½ï¼šç§’ï¼Œæœ€å¥½å¤§äºŽ2ï¼ˆå°¤å…¶å¼€å¯è‡ªåŠ¨è½®æ’­æ—¶ï¼‰
    };
    ...
    // æŽ§ä»¶è¡Œä¸ºæ·»åŠ (Interact with user's touch/mousedown)
    ...
    /**
     * @name    Slider è½®æ’­
     * @param   {String/DOM}  containerSelector  containeré€‰æ‹©å™¨ï¼Œæˆ–DOMå…ƒç´ ã€‚
     * @param   {String/Array}  itemSelector  itemé€‰æ‹©å™¨ï¼Œæˆ–DOMå…ƒç´ æ•°ç»„ã€‚
     * @param   {Object}  é…ç½®é¡¹ï¼Œå¯é€‰ã€‚
     * @return  {Object}  Sliderå®žä¾‹
     */
