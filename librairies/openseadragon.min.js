...
function OpenSeadragon(e) { return new OpenSeadragon.Viewer(e) } ! function (e) {
    e.version = { versionStr: "2.4.0", major: parseInt("2", 10), minor: parseInt("4", 10), revision: parseInt("0", 10) };
    ...
    $.extend($, {
        ...
        getCssPropertyWithVendorPrefix: function (e) {
            ...
            $.getCssPropertyWithVendorPrefix = function (e) {
                ...
                var n = null;
                if (void 0 !== i[e]) n = e;
                else { var o = ["Webkit", "Moz", "MS", "O", "webkit", "moz", "ms", "o"]; var r = $.capitalizeFirstLetter(e); for (var s = 0; s < o.length; s++) { var a = o[s] + r; if (void 0 !== i[a]) { n = a; break } } }
                t[e] = n;
                return n
            };
        ...
        createCallback: function (e, t) { var i, n = []; for (i = 2; i < arguments.length; i++) n.push(arguments[i]); return function () { var i, o = n.concat([]); for (i = 0; i < arguments.length; i++) o.push(arguments[i]); return t.apply(e, o) } },
        ...
        makeAjaxRequest: function (e, t, i) {
            ...
            try {
                ...
                if (window.XDomainRequest) {
                    ...
                    if (c) {
                        c.onload = function (e) { $.isFunction(t) && t({ responseText: c.responseText, status: 200, statusText: "OK" }) };
                        c.onerror = function (e) { $.isFunction(i) && i({ responseText: c.responseText, status: 444, statusText: "An error happened. Due to an XDomainRequest deficiency we can not extract any information about this error. Upgrade your browser." }) };
                        try {
                            c.open("GET", e);
                            c.send()
                        } catch (e) { $.isFunction(i) && i(a, n) }
                    }
...
! function (e) {
    e.EventSource = function () { this.events = {} };
...
! function (e) {
    ...
    e.MouseTracker = function (n) {
        ...
        var r = this;
        i[this.hash] = {
            click: function (t) { i = t, r.clickHandler && e.cancelEvent(i); var i },
            dblclick: function (t) { i = t, r.dblClickHandler && e.cancelEvent(i); var i },
            keydown: function (t) {
                ! function (t, i) {
                    if (t.keyDownHandler) {
                        i = e.getEvent(i);
                        t.keyDownHandler({ eventSource: t, keyCode: i.keyCode ? i.keyCode : i.charCode, ctrl: i.ctrlKey, shift: i.shiftKey, alt: i.altKey, meta: i.metaKey, originalEvent: i, preventDefaultAction: !1, userData: t.userData }) || e.cancelEvent(i)
                    }
                }(r, t)
            },
            keyup: function (t) {
                ! function (t, i) {
                    if (t.keyUpHandler) {
                        i = e.getEvent(i);
                        t.keyUpHandler({ eventSource: t, keyCode: i.keyCode ? i.keyCode : i.charCode, ctrl: i.ctrlKey, shift: i.shiftKey, alt: i.altKey, meta: i.metaKey, originalEvent: i, preventDefaultAction: !1, userData: t.userData }) || e.cancelEvent(i)
                    }
                }(r, t)
            },
            keypress: function (t) {
                ! function (t, i) {
                    if (t.keyHandler) {
                        i = e.getEvent(i);
                        t.keyHandler({ eventSource: t, keyCode: i.keyCode ? i.keyCode : i.charCode, ctrl: i.ctrlKey, shift: i.shiftKey, alt: i.altKey, meta: i.metaKey, originalEvent: i, preventDefaultAction: !1, userData: t.userData }) || e.cancelEvent(i)
                    }
                }(r, t)
            },
            focus: function (t) { ! function (t, i) { if (t.focusHandler) { i = e.getEvent(i); !1 === t.focusHandler({ eventSource: t, originalEvent: i, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(i) } }(r, t) },
            blur: function (t) { ! function (t, i) { if (t.blurHandler) { i = e.getEvent(i); !1 === t.blurHandler({ eventSource: t, originalEvent: i, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(i) } }(r, t) },
            wheel: function (e) { g(r, t = e, t); var t },
            mousewheel: function (e) { p(r, e) },
            DOMMouseScroll: function (e) { p(r, e) },
            MozMousePixelScroll: function (e) { p(r, e) },
            ...
            mousedown: function (t) {
                ! function (t, i) {
                    var n;
                    i = e.getEvent(i);
                    n = { id: e.MouseTracker.mousePointerId, type: "mouse", isPrimary: !0, currentPos: h(i), currentTime: e.now() };
            ...
            touchstart: function (i) {
                ! function (i, n) {
                    ...
                    for (r = 0; r < c; r++) u.push({ id: n.changedTouches[r].identifier, type: "touch", currentPos: h(n.changedTouches[r]), currentTime: o });
                    z(i, n, u);
                    for (r = 0; r < t.length; r++)
                        if (t[r] !== i && t[r].isTracking() && m(t[r].element, i.element)) {
                            l = [];
                            for (a = 0; a < c; a++) l.push({ id: n.changedTouches[a].identifier, type: "touch", currentPos: h(n.changedTouches[a]), currentTime: o });
                            z(t[r], n, l)
                        }
                    if (H(i, n, u, 0)) {
                        e.stopEvent(n);
            ...
            pointerover: function (e) { P(r, e) },
            MSPointerOver: function (e) { P(r, e) },
            pointerout: function (e) { R(r, e) },
            MSPointerOut: function (e) { R(r, e) },
            pointerdown: function (e) { _(r, e) },
            MSPointerDown: function (e) { _(r, e) },
            pointerup: function (e) { C(r, e) },
            MSPointerUp: function (e) { C(r, e) },
            pointermove: function (e) { O(r, e) },
            MSPointerMove: function (e) { O(r, e) },
            pointercancel: function (e) { k(r, e) },
            MSPointerCancel: function (e) { k(r, e) },
    ...
    e.MouseTracker.prototype = {
        ...
        isTracking: function () { return i[this.hash].tracking },
        ...
        getActivePointersListsExceptType: function (e) { var t = i[this.hash]; var n = []; for (var o = 0; o < t.activePointersLists.length; ++o) t.activePointersLists[o].type !== e && n.push(t.activePointersLists[o]); return n },
    ...
    e.MouseTracker.gesturePointVelocityTracker = function () {
        var t = [],
            i = 0,
            n = 0;
        var o = function (e, t) { return e.hash.toString() + t.type + t.id.toString() };
        var r = function () {
    ...
    function p(t, i) {
        var n = { target: (i = e.getEvent(i)).target || i.srcElement, type: "wheel", shiftKey: i.shiftKey || !1, clientX: i.clientX, clientY: i.clientY, pageX: i.pageX ? i.pageX : i.clientX, pageY: i.pageY ? i.pageY : i.clientY, deltaMode: "MozMousePixelScroll" == i.type ? 0 : 1, deltaX: 0, deltaZ: 0 };
    ...
    function S(i, n) {
        ...
        for (r = 0; r < t.length; r++)
            if (t[r] !== i && t[r].isTracking() && m(t[r].element, i.element)) {
                l = [];
                for (s = 0; s < c; s++) l.push({ id: n.changedTouches[s].identifier, type: "touch", currentPos: h(n.changedTouches[s]), currentTime: o });
                M(t[r], n, l)
            }
        e.cancelEvent(n)
    }
    ...
    function E(t, i) {
        var n, o = i.changedTouches.length,
            r = [];
        for (n = 0; n < o; n++) r.push({ id: i.changedTouches[n].identifier, type: "touch", currentPos: h(i.changedTouches[n]), currentTime: e.now() });
        F(t, i, r);
        e.cancelEvent(i)
    }
    ...
    function _(t, i) {
        var n;
        if (H(t, i, [n = { id: i.pointerId, type: l(i), isPrimary: i.isPrimary, currentPos: h(i), currentTime: e.now() }], i.button)) {
            e.stopEvent(i);
            s(t, n.type)
    ...
    function H(t, n, o, r) {
        ...
        if (0 !== r) { t.nonPrimaryPressHandler && !1 === t.nonPrimaryPressHandler({ eventSource: t, pointerType: o[0].type, position: u(o[0].currentPos, t.element), button: r, buttons: c.buttons, isTouchEvent: "touch" === o[0].type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n); return !1 }
        for (s = 0; s < p; s++) {
            a = o[s];
            if (l = c.getById(a.id)) {
                l.captured = !0;
            ...
            if (1 === c.contacts) t.pressHandler && !1 === t.pressHandler({ eventSource: t, pointerType: a.type, position: u(a.contactPos, t.element), buttons: c.buttons, isTouchEvent: "touch" === a.type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n);
    ...
    function L(t, n, o, r) {
        ...
        if (0 !== r) {
            t.nonPrimaryReleaseHandler && !1 === t.nonPrimaryReleaseHandler({ eventSource: t, pointerType: o[0].type, position: u(o[0].currentPos, t.element), button: r, buttons: m.buttons, isTouchEvent: "touch" === o[0].type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n);
        ...
        for (l = 0; l < v; l++) {
            ...
            if (c = m.getById(h.id)) {
                ...
                if (w) {
                    ...
                    if (0 === m.contacts) {
                        t.releaseHandler && !1 === t.releaseHandler({ eventSource: t, pointerType: c.type, position: u(s, t.element), buttons: m.buttons, insideElementPressed: c.insideElementPressed, insideElementReleased: c.insideElement, isTouchEvent: "touch" === c.type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n);
                        t.dragEndHandler && !c.currentPos.equals(c.contactPos) && !1 === t.dragEndHandler({ eventSource: t, pointerType: c.type, position: u(c.currentPos, t.element), speed: c.speed, direction: c.direction, shift: n.shiftKey, isTouchEvent: "touch" === c.type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n);
                        if ((t.clickHandler || t.dblClickHandler) && c.insideElement) {
                            ...
                            t.clickHandler && !1 === t.clickHandler({ eventSource: t, pointerType: c.type, position: u(c.currentPos, t.element), quick: p, shift: n.shiftKey, isTouchEvent: "touch" === c.type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n);
                            if (t.dblClickHandler && p) {
                                m.clicks++;
                                if (1 === m.clicks) {
                                    g.lastClickPos = s;
                                    g.dblClickTimeOut = setTimeout(function () { m.clicks = 0 }, t.dblClickTimeThreshold)
                                } else if (2 === m.clicks) {
                ...
                } else t.releaseHandler && !1 === t.releaseHandler({ eventSource: t, pointerType: c.type, position: u(s, t.element), buttons: m.buttons, insideElementPressed: c.insideElementPressed, insideElementReleased: c.insideElement, isTouchEvent: "touch" === c.type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n)
            }
        }
        return f
    }
    ...
    function F(t, n, o) {
        ...
        if (t.stopHandler && "mouse" === o[0].type) {
            ...
            t.stopTimeOut = setTimeout(function () { e = t, i = n, r = o[0].type, e.stopHandler && e.stopHandler({ eventSource: e, pointerType: r, position: c(i, e.element), buttons: e.getActivePointersListByType(r).buttons, isTouchEvent: "touch" === r, originalEvent: i, preventDefaultAction: !1, userData: e.userData }); var e, i, r }, t.stopDelay)
        }
        if (0 === g.contacts) t.moveHandler && !1 === t.moveHandler({ eventSource: t, pointerType: o[0].type, position: u(o[0].currentPos, t.element), buttons: g.buttons, isTouchEvent: "touch" === o[0].type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n);
        else if (1 === g.contacts) { if (t.moveHandler) { a = g.asArray()[0]; !1 === t.moveHandler({ eventSource: t, pointerType: a.type, position: u(a.currentPos, t.element), buttons: g.buttons, isTouchEvent: "touch" === a.type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n) } if (t.dragHandler) { h = (a = g.asArray()[0]).currentPos.minus(a.lastPos); !1 === t.dragHandler({ eventSource: t, pointerType: a.type, position: u(a.currentPos, t.element), buttons: g.buttons, delta: h, speed: a.speed, direction: a.direction, shift: n.shiftKey, isTouchEvent: "touch" === a.type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n) } } else if (2 === g.contacts) {
            if (t.moveHandler) { l = g.asArray(); !1 === t.moveHandler({ eventSource: t, pointerType: l[0].type, position: u(d(l[0].currentPos, l[1].currentPos), t.element), buttons: g.buttons, isTouchEvent: "touch" === l[0].type, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n) }
            if (t.pinchHandler && "touch" === o[0].type && (h = p.pinchGPoints[0].currentPos.distanceTo(p.pinchGPoints[1].currentPos)) != p.currentPinchDist) {
                ...
                !1 === t.pinchHandler({ eventSource: t, pointerType: "touch", gesturePoints: p.pinchGPoints, lastCenter: u(p.lastPinchCenter, t.element), center: u(p.currentPinchCenter, t.element), lastDistance: p.lastPinchDist, distance: p.currentPinchDist, shift: n.shiftKey, originalEvent: n, preventDefaultAction: !1, userData: t.userData }) && e.cancelEvent(n)
            }
        }
    }
    var N = function () { try { return window.self !== window.top } catch (e) { return !0 } }();

    function A(e) { try { return e.addEventListener && e.removeEventListener } catch (e) { return !1 } }
}(OpenSeadragon);
! function (e) {
    ...
    e.Control.prototype = {
        ...
        setVisible: function (t) { this.wrapper.style.display = t ? this.anchor == e.ControlAnchor.ABSOLUTE ? "block" : "inline-block" : "none" },
        setOpacity: function (t) { this.element[e.SIGNAL] && e.Browser.vendor == e.BROWSERS.IE ? e.setElementOpacity(this.element, t, !0) : e.setElementOpacity(this.wrapper, t, !0) }
    }
}(OpenSeadragon);
! function (e) {
    ...
    e.ControlDock.prototype = {
        ...
        clearControls: function () { for (; this.controls.length > 0;) this.controls.pop().destroy(); return this },
        ...
        setControlsEnabled: function (e) { var t; for (t = this.controls.length - 1; t >= 0; t--) this.controls[t].setVisible(e); return this }
    };
...
! function (e) {
    ...
    e.Viewer = function (o) {
        var r, a = arguments,
            h = this;
        e.isPlainObject(o) || (o = { id: a[0], xmlPath: a.length > 1 ? a[1] : void 0, prefixUrl: a.length > 2 ? a[2] : void 0, controls: a.length > 3 ? a[3] : void 0, overlays: a.length > 4 ? a[4] : void 0 });
        if (o.config) {
            e.extend(!0, o, o.config);
            delete o.config
        }
        e.extend(!0, this, { id: o.id, hash: o.hash || i++, initialPage: 0, element: null, container: null, canvas: null, overlays: [], overlaysContainer: null, previousBody: [], customControls: [], source: null, drawer: null, world: null, viewport: null, navigator: null, collectionViewport: null, collectionDrawer: null, navImages: null, buttons: null, profiler: null }, e.DEFAULT_SETTINGS, o);
        ...
        this.showNavigator && (this.navigator = new e.Navigator({ id: this.navigatorId, position: this.navigatorPosition, sizeRatio: this.navigatorSizeRatio, maintainSizeRatio: this.navigatorMaintainSizeRatio, top: this.navigatorTop, left: this.navigatorLeft, width: this.navigatorWidth, height: this.navigatorHeight, autoResize: this.navigatorAutoResize, autoFade: this.navigatorAutoFade, prefixUrl: this.prefixUrl, viewer: this, navigatorRotate: this.navigatorRotate, background: this.navigatorBackground, opacity: this.navigatorOpacity, borderColor: this.navigatorBorderColor, displayRegionColor: this.navigatorDisplayRegionColor, crossOriginPolicy: this.crossOriginPolicy }));
        this.sequenceMode && this.bindSequenceControls();
        this.tileSources && this.open(this.tileSources);
        for (r = 0; r < this.customControls.length; r++) this.addControl(this.customControls[r].id, { anchor: this.customControls[r].anchor });
    ...
    e.extend(e.Viewer.prototype, e.EventSource.prototype, e.ControlDock.prototype, {
        ...
        openDzi: function (t) { e.console.error("[Viewer.openDzi] this function is deprecated; use Viewer.open() instead."); return this.open(t) },
        openTileSource: function (t) { e.console.error("[Viewer.openTileSource] this function is deprecated; use Viewer.open() instead."); return this.open(t) },
        open: function (t, i) {
            var n = this;
            this.close();
            if (t)
        ...
        areControlsEnabled: function () { var e, t = this.controls.length; for (e = 0; e < this.controls.length; e++) t = t && this.controls[e].isVisibile(); return t },
        ...
        isFullPage: function () { return t[this.hash].fullPage },
        setFullPage: function (i) {
            ...
            if (i) {
                ...
                var c = 0;
                var u = function () { e.setPageScroll(l.pageScroll); var t = e.getPageScroll(); ++c < 10 && (t.x !== l.pageScroll.x || t.y !== l.pageScroll.y) && e.requestAnimationFrame(u) };
        ...
        addTiledImage: function (t) {
            ...
            function o(e) {
                for (var o = 0; o < i._loadQueue.length; o++)
                    if (i._loadQueue[o] === n) { i._loadQueue.splice(o, 1); break }
            ...
            function r(e) {
                if (i.collectionMode) {
                    i.world.arrange({ immediately: e.options.collectionImmediately, rows: i.collectionRows, columns: i.collectionColumns, layout: i.collectionLayout, tileSize: i.collectionTileSize, tileMargin: i.collectionTileMargin });
                    i.world.setAutoRefigureSizes(!0)
                }
            }
            if (e.isArray(t.tileSource)) setTimeout(function () { o({ message: "[Viewer.addTiledImage] Sequences can not be added; add them one at a time instead.", source: t.tileSource, options: t }) });
            else {
                ...
                ! function (t, i, n, o, r) {
                    ...
                    function l(e, t) {
                        if (e.ready) o(e);
                            ...
                            e.addHandler("ready", function () { o(e) });
                            e.addHandler("open-failed", function (e) { r({ message: e.message, source: t }) })
                        }
                    }
                    setTimeout(function () {
                        if ("string" == e.type(i)) (i = new e.TileSource({ url: i, crossOriginPolicy: void 0 !== n.crossOriginPolicy ? n.crossOriginPolicy : t.crossOriginPolicy, ajaxWithCredentials: t.ajaxWithCredentials, ajaxHeaders: t.ajaxHeaders, useCanvas: t.useCanvas, success: function (e) { o(e.tileSource) } })).addHandler("open-failed", function (e) { r(e) });
                            ...
                            if (e.isFunction(i.getTileUrl)) {
                                ...
                                if (!h) { r({ message: "Unable to load TileSource", source: i }); return }
            ...
            function s() {
                ...
                for (; i._loadQueue.length && (t = i._loadQueue[0]).tileSource;) {
                    ...
                    if (i.navigator) {
                        o = e.extend({}, t.options, { replace: !1, originalTiledImage: n, tileSource: t.tileSource });
        ...
        addLayer: function (t) {
            ...
            var n = e.extend({}, t, { success: function (e) { i.raiseEvent("add-layer", { options: t, drawer: e.item }) }, error: function (e) { i.raiseEvent("add-layer-failed", e) } });
            this.addTiledImage(n);
            return this
        },
        getLayerAtLevel: function (t) { e.console.error("[Viewer.getLayerAtLevel] this function is deprecated; use World.getItemAt() instead."); return this.world.getItemAt(t) },
        getLevelOfLayer: function (t) { e.console.error("[Viewer.getLevelOfLayer] this function is deprecated; use World.getIndexOfItem() instead."); return this.world.getIndexOfItem(t) },
        getLayersCount: function () { e.console.error("[Viewer.getLayersCount] this function is deprecated; use World.getItemCount() instead."); return this.world.getItemCount() },
        setLayerLevel: function (t, i) { e.console.error("[Viewer.setLayerLevel] this function is deprecated; use World.setItemIndex() instead."); return this.world.setItemIndex(t, i) },
        removeLayer: function (t) { e.console.error("[Viewer.removeLayer] this function is deprecated; use World.removeItem() instead."); return this.world.removeItem(t) },
        forceRedraw: function () { t[this.hash].forceRedraw = !0; return this },
        bindSequenceControls: function () {
            ...
            if (this.showSequenceControl) {
                ...
                if (s) {
                    ...
                    this.toolbar ? this.toolbar.addControl(this.pagingControl, { anchor: e.ControlAnchor.BOTTOM_RIGHT }) : this.addControl(this.pagingControl, { anchor: this.sequenceControlAnchor || e.ControlAnchor.TOP_LEFT })
                }
            }
            return this
        },
        bindStandardControls: function () {
            ...
            if (this.showNavigationControl) {
                ...
                this.showFullPageControl && v.push(this.fullPageButton = new e.Button({ element: this.fullPageButton ? e.getElement(this.fullPageButton) : null, clickTimeThreshold: this.clickTimeThreshold, clickDistThreshold: this.clickDistThreshold, tooltip: e.getString("Tooltips.FullPage"), srcRest: O(this.prefixUrl, m.fullpage.REST), srcGroup: O(this.prefixUrl, m.fullpage.GROUP), srcHover: O(this.prefixUrl, m.fullpage.HOVER), srcDown: O(this.prefixUrl, m.fullpage.DOWN), onRelease: a, onFocus: p, onBlur: g }));
                if (this.showRotationControl) {
                    ...
                    v.push(this.rotateRightButton = new e.Button({ element: this.rotateRightButton ? e.getElement(this.rotateRightButton) : null, clickTimeThreshold: this.clickTimeThreshold, clickDistThreshold: this.clickDistThreshold, tooltip: e.getString("Tooltips.RotateRight"), srcRest: O(this.prefixUrl, m.rotateright.REST), srcGroup: O(this.prefixUrl, m.rotateright.GROUP), srcHover: O(this.prefixUrl, m.rotateright.HOVER), srcDown: O(this.prefixUrl, m.rotateright.DOWN), onRelease: h, onFocus: p, onBlur: g }))
                }
                this.showFlipControl && v.push(this.flipButton = new e.Button({ element: this.flipButton ? e.getElement(this.flipButton) : null, clickTimeThreshold: this.clickTimeThreshold, clickDistThreshold: this.clickDistThreshold, tooltip: e.getString("Tooltips.Flip"), srcRest: O(this.prefixUrl, m.flip.REST), srcGroup: O(this.prefixUrl, m.flip.GROUP), srcHover: O(this.prefixUrl, m.flip.HOVER), srcDown: O(this.prefixUrl, m.flip.DOWN), onRelease: d, onFocus: p, onBlur: g }));
                if (f) {
                    this.buttons = new e.ButtonGroup({ buttons: v, clickTimeThreshold: this.clickTimeThreshold, clickDistThreshold: this.clickDistThreshold });
                    this.navControl = this.buttons.element;
                    this.addHandler("open", e.delegate(this, L));
                    this.toolbar ? this.toolbar.addControl(this.navControl, { anchor: this.navigationControlAnchor || e.ControlAnchor.TOP_LEFT }) : this.addControl(this.navControl, { anchor: this.navigationControlAnchor || e.ControlAnchor.TOP_LEFT })
                }
            }
            return this
        },
    ...
    function o(t, i) {
        ...
        return new e.Overlay({ element: n, location: r, placement: u, onDraw: i.onDraw, checkResize: i.checkResize, width: s, height: a, rotationMode: i.rotationMode })
    }
    ...
    function d(t) {
        var i = { originalEvent: t.originalEvent, preventDefaultAction: t.preventDefaultAction, preventVerticalPan: t.preventVerticalPan, preventHorizontalPan: t.preventHorizontalPan };
    ...
    function f(t) {
        ...
        this.raiseEvent("canvas-drag-end", { tracker: t.eventSource, position: t.position, speed: t.speed, direction: t.direction, shift: t.shift, originalEvent: t.originalEvent })
    }
    ...
    function R(t) {
        ...
        if ((o = e.now()) - this._lastScrollTime > this.minScrollDeltaTime) {
            ...
            this.raiseEvent("canvas-scroll", { tracker: t.eventSource, position: t.position, scroll: t.scroll, shift: t.shift, originalEvent: t.originalEvent });
...
! function (e) {
    e.Navigator = function (s) {
        ...
        if (s.id) {
            ...
            s.controlOptions = { anchor: e.ControlAnchor.TOP_RIGHT, attachToViewer: !0, autoFade: s.autoFade };
            if (s.position)
        ...
        if (s.navigatorRotate) {
            ...
            s.viewer.addHandler("rotate", function (e) { u(e.degrees) })
        }
...
! function (e) {
    ...
    e.extend(e, {
        getString: function (i) {
            ...
            return r.replace(/\{\d+\}/g, function (e) { var t = parseInt(e.match(/\d+/), 10) + 1; return t < s.length ? s[t] : "" })
        },
...
! function (e) {
    ...
    e.Point.prototype = {
        clone: function () { return new e.Point(this.x, this.y) },
        plus: function (t) { return new e.Point(this.x + t.x, this.y + t.y) },
        minus: function (t) { return new e.Point(this.x - t.x, this.y - t.y) },
        times: function (t) { return new e.Point(this.x * t, this.y * t) },
        divide: function (t) { return new e.Point(this.x / t, this.y / t) },
        negate: function () { return new e.Point(-this.x, -this.y) },
        ...
        apply: function (t) { return new e.Point(t(this.x), t(this.y)) },
        equals: function (t) { return t instanceof e.Point && this.x === t.x && this.y === t.y },
        rotate: function (t, i) {
            i = i || new e.Point(0, 0);
            var n;
            var o;
...
! function (e) {
    e.TileSource = function (t, i, n, o, r, s) {
        ...
        if (!this.success)
            for (h = 0; h < arguments.length; h++)
                if (e.isFunction(arguments[h])) { this.success = arguments[h]; break }
        this.success && this.addHandler("ready", function (e) { a.success(e) });
    ...
    e.TileSource.prototype = {
        getTileSize: function (t) { e.console.error("[TileSource.getTileSize] is deprecated.Use TileSource.getTileWidth() and TileSource.getTileHeight() instead"); return this._tileWidth },
        ...
        getClosestLevel: function () { var e, t; for (e = this.minLevel + 1; e <= this.maxLevel && !((t = this.getNumTiles(e)).x > 1 || t.y > 1); e++); return e - 1 },
            ...
            if (t.match(/\.js$/)) {
                ...
                success: function (t) {
                    var i = function (t) {
                        ...
                        if (o.match(/\s*<.*/)) try { n = t.responseXML && t.responseXML.documentElement ? t.responseXML : e.parseXml(o) } catch (e) { n = t.responseText } else if (o.match(/\s*[\{\[].*/)) try { n = e.parseJSON(o) } catch (e) { n = o } else n = o;
                        return n
                    }(t);
                    n(i)
                },
                error: function (e, i) {
                    var n;
                    try { n = "HTTP " + e.status + " attempting to load TileSource" } catch (e) {
                        var o;
        ...
        tileExists: function (e, t, i) { var n = this.getNumTiles(e); return e >= this.minLevel && e <= this.maxLevel && t >= 0 && i >= 0 && t < n.x && i < n.y }
    };
...
! function (e) {
        ...
        configure: function (i, n) {
            ...
            o = e.isPlainObject(i) ? t(this, i) : function (i, n) {
                ...
                if ("Image" == c) try {
                    ...
                    d = { Image: { xmlns: "http://schemas.microsoft.com/deepzoom/2008", Url: h.getAttribute("Url"), Format: h.getAttribute("Format"), DisplayRect: null, Overlap: parseInt(h.getAttribute("Overlap"), 10), TileSize: parseInt(h.getAttribute("TileSize"), 10), Size: { Height: parseInt(a.getAttribute("Height"), 10), Width: parseInt(a.getAttribute("Width"), 10) } } };
                    ...
                    for (l = 0; l < o.length; l++) {
                        ...
                        p.push({ Rect: { X: parseInt(s.getAttribute("X"), 10), Y: parseInt(s.getAttribute("Y"), 10), Width: parseInt(s.getAttribute("Width"), 10), Height: parseInt(s.getAttribute("Height"), 10), MinLevel: parseInt(r.getAttribute("MinLevel"), 10), MaxLevel: parseInt(r.getAttribute("MaxLevel"), 10) } })
                    }
                    p.length && (d.Image.DisplayRect = p);
                    return t(i, d)
                } catch (t) { throw t instanceof Error ? t : new Error(e.getString("Errors.Dzi")) } else { if ("Collection" == c) throw new Error(e.getString("Errors.Dzc")); if ("Error" == c) { var g = h.getElementsByTagName("Message")[0]; var m = g.firstChild.nodeValue; throw new Error(m) } }
                throw new Error(e.getString("Errors.Dzi"))
            }(this, i);
            if (n && !o.tilesUrl) { o.tilesUrl = n.replace(/([^\/]+?)(\.(dzi|xml|js)?(\?[^\/]*)?)?\/?$/, "$1_files/"); - 1 != n.search(/\.(dzi|xml|js)\?/) ? o.queryParams = n.match(/\?.*/) : o.queryParams = "" }
            return o
        },
    ...
    function t(t, i) {
        ...
        return e.extend(!0, { width: c, height: u, tileSize: d, tileOverlap: p, minLevel: null, maxLevel: null, tilesUrl: s, fileFormat: a, displayRects: g }, i)
    }
}(OpenSeadragon);
! function (e) {
            ...
            if (1 == this.tiles.length) {
                ...
                for (var i = 0; i < this.tiles.length; i++)
                    for (var n = 0; n < this.tiles[i].scaleFactors.length; n++) {
                        ...
                        t.tileSizePerScaleFactor[o] = { width: this.tiles[i].width, height: this.tiles[i].height || this.tiles[i].width }
                    }
            }
    ...
    e.extend(e.IIIFTileSource.prototype, e.TileSource.prototype, {
        ...
        configure: function (t, i) {
            ...
            var n = function (t) {
                ...
                if ("info" == i.tagName) try {
                    ...
                    return n
                } catch (t) { throw t instanceof Error ? t : new Error(e.getString("Errors.IIIF")) }
        ...
        getTileWidth: function (t) { if (this.emulateLegacyImagePyramid) return e.TileSource.prototype.getTileWidth.call(this, t); var i = Math.pow(2, this.maxLevel - t); return this.tileSizePerScaleFactor && this.tileSizePerScaleFactor[i] ? this.tileSizePerScaleFactor[i].width : this._tileWidth },
        getTileHeight: function (t) { if (this.emulateLegacyImagePyramid) return e.TileSource.prototype.getTileHeight.call(this, t); var i = Math.pow(2, this.maxLevel - t); return this.tileSizePerScaleFactor && this.tileSizePerScaleFactor[i] ? this.tileSizePerScaleFactor[i].height : this._tileHeight },
        ...
        getNumTiles: function (t) { if (this.emulateLegacyImagePyramid) { return this.getLevelScale(t) ? new e.Point(1, 1) : new e.Point(0, 0) } return e.TileSource.prototype.getNumTiles.call(this, t) },
        getTileAtPoint: function (t, i) { return this.emulateLegacyImagePyramid ? new e.Point(0, 0) : e.TileSource.prototype.getTileAtPoint.call(this, t, i) },
...
! function (e) {
    e.OsmTileSource = function (t, i, n, o, r) {
        var s;
        if (!(s = e.isPlainObject(t) ? t : { width: arguments[0], height: arguments[1], tileSize: arguments[2], tileOverlap: arguments[3], tilesUrl: arguments[4] }).width || !s.height) {
            s.width = 65572864;
            s.height = 65572864
        }
        if (!s.tileSize) {
    ...
    e.extend(e.OsmTileSource.prototype, e.TileSource.prototype, { supports: function (e, t) { return e.type && "openstreetmaps" == e.type }, configure: function (e, t) { return e }, getTileUrl: function (e, t, i) { return this.tilesUrl + (e - 8) + "/" + t + "/" + i + ".png" } })
}(OpenSeadragon);
! function (e) {
    e.TmsTileSource = function (t, i, n, o, r) {
        var s;
        s = e.isPlainObject(t) ? t : { width: arguments[0], height: arguments[1], tileSize: arguments[2], tileOverlap: arguments[3], tilesUrl: arguments[4] };
    ...
    e.extend(e.TmsTileSource.prototype, e.TileSource.prototype, { supports: function (e, t) { return e.type && "tiledmapservice" == e.type }, configure: function (e, t) { return e }, getTileUrl: function (e, t, i) { var n = this.getNumTiles(e).y - 1; return this.tilesUrl + e + "/" + t + "/" + (n - i) + ".png" } })
}(OpenSeadragon);
! function (e) {
...
! function (e) {
    e.LegacyTileSource = function (t) {
        ...
        i.levels = function (t) { var i, n, o = []; for (n = 0; n < t.length; n++)(i = t[n]).height && i.width && i.url ? o.push({ url: i.url, width: Number(i.width), height: Number(i.height) }) : e.console.error("Unsupported image format: %s", i.url ? i.url : "<no URL>"); return o.sort(function (e, t) { return e.height - t.height }) }(i.levels);
        ...
        e.extend(!0, i, { width: n, height: o, tileSize: Math.max(o, n), tileOverlap: 0, minLevel: 0, maxLevel: i.levels.length > 0 ? i.levels.length - 1 : 0 });
    ...
    e.extend(e.LegacyTileSource.prototype, e.TileSource.prototype, {
            ...
            return e.isPlainObject(i) ? t(this, i) : function (i, n) {
                ...
                if ("image" == a) try {
                    ...
                    for (r = 0; r < h.length; r++) {
                        o = h[r];
                        l.levels.push({ url: o.getAttribute("url"), width: parseInt(o.getAttribute("width"), 10), height: parseInt(o.getAttribute("height"), 10) })
                    }
                    return t(i, l)
                } catch (e) { throw e instanceof Error ? e : new Error("Unknown error parsing Legacy Image Pyramid XML.") } else { if ("collection" == a) throw new Error("Legacy Image Pyramid Collections not yet supported."); if ("error" == a) throw new Error("Error: " + n) }
        ...
        getNumTiles: function (t) { return this.getLevelScale(t) ? new e.Point(1, 1) : new e.Point(0, 0) },
        getTileUrl: function (e, t, i) {
            var n = null;
            this.levels.length > 0 && e >= this.minLevel && e <= this.maxLevel && (n = this.levels[e].url);
            return n
    ...
    function t(e, t) { return t.levels }
}(OpenSeadragon);
! function (e) {
    ...
    e.extend(e.ImageTileSource.prototype, e.TileSource.prototype, {
        ...
        _buildLevels: function () {
            var t = [{ url: this._image.src, width: Object.prototype.hasOwnProperty.call(this._image, "naturalWidth") ? this._image.naturalWidth : this._image.width, height: Object.prototype.hasOwnProperty.call(this._image, "naturalHeight") ? this._image.naturalHeight : this._image.height }];
            if (!this.buildPyramid || !e.supportsCanvas || !this.useCanvas) { delete this._image; return t }
...
! function (e) {
    ...
    e.Button = function (t) {
        ...
        this.tracker = new e.MouseTracker({
            ...
            clickHandler: function (e) { e.quick && o.raiseEvent("click", { originalEvent: e.originalEvent }) },
    ...
    e.extend(e.Button.prototype, e.EventSource.prototype, {
        notifyGroupEnter: function () { i(this, e.ButtonState.GROUP) },
        notifyGroupExit: function () { n(this, e.ButtonState.REST) },
        disable: function () {
        ...
        if (!i.element.disabled) {
            ...
            if (n <= e.ButtonState.REST && i.currentState == e.ButtonState.GROUP) {
                ! function (i) {
                    ...
                    window.setTimeout(function () { t(i) }, i.fadeDelay)
                }(i);
...
! function (e) {
    e.ButtonGroup = function (t) {
        ...
        this.tracker = new e.MouseTracker({
            ...
            clickTimeThreshold: this.clickTimeThreshold,
            clickDistThreshold: this.clickDistThreshold,
            enterHandler: function (e) { var t; for (t = 0; t < o.buttons.length; t++) o.buttons[t].notifyGroupEnter() },
    ...
    e.ButtonGroup.prototype = { emulateEnter: function () { this.tracker.enterHandler({ eventSource: this.tracker }) }, emulateExit: function () { this.tracker.exitHandler({ eventSource: this.tracker }) } }
}(OpenSeadragon);
! function (e) {
    ...
    e.Rect.prototype = {
        clone: function () { return new e.Rect(this.x, this.y, this.width, this.height, this.degrees) },
        getAspectRatio: function () { return this.width / this.height },
        getTopLeft: function () { return new e.Point(this.x, this.y) },
        getBottomRight: function () { return new e.Point(this.x + this.width, this.y + this.height).rotate(this.degrees, this.getTopLeft()) },
        getTopRight: function () { return new e.Point(this.x + this.width, this.y).rotate(this.degrees, this.getTopLeft()) },
        getBottomLeft: function () { return new e.Point(this.x, this.y + this.height).rotate(this.degrees, this.getTopLeft()) },
        getCenter: function () { return new e.Point(this.x + this.width / 2, this.y + this.height / 2).rotate(this.degrees, this.getTopLeft()) },
        getSize: function () { return new e.Point(this.width, this.height) },
        equals: function (t) { return t instanceof e.Rect && this.x === t.x && this.y === t.y && this.width === t.width && this.height === t.height && this.degrees === t.degrees },
        times: function (t) { return new e.Rect(this.x * t, this.y * t, this.width * t, this.height * t, this.degrees) },
        translate: function (t) { return new e.Rect(this.x + t.x, this.y + t.y, this.width, this.height, this.degrees) },
        union: function (t) { var i = this.getBoundingBox(); var n = t.getBoundingBox(); var o = Math.min(i.x, n.x); var r = Math.min(i.y, n.y); var s = Math.max(i.x + i.width, n.x + n.width); var a = Math.max(i.y + i.height, n.y + n.height); return new e.Rect(o, r, s - o, a - r) },
        intersection: function (t) {
            ...
            function y(t, n, o, r) { var s = n.minus(t); var a = r.minus(o); var l = -a.x * s.y + s.x * a.y; if (0 === l) return null; var h = (s.x * (t.y - o.y) - s.y * (t.x - o.x)) / l; var c = (a.x * (t.y - o.y) - a.y * (t.x - o.x)) / l; return -i <= h && h <= 1 - i && -i <= c && c <= 1 - i ? new e.Point(t.x + c * s.x, t.y + c * s.y) : null }
        ...
        rotate: function (t, i) {
            ...
            o = o.apply(function (e) { return Math.abs(e) < 1e-15 ? 0 : e });
            var r = Math.atan(o.y / o.x);
            o.x < 0 ? r += Math.PI : o.y < 0 && (r += 2 * Math.PI);
            return new e.Rect(n.x, n.y, this.width, this.height, r / Math.PI * 180)
        },
        getBoundingBox: function () { if (0 === this.degrees) return this.clone(); var t = this.getTopLeft(); var i = this.getTopRight(); var n = this.getBottomLeft(); var o = this.getBottomRight(); var r = Math.min(t.x, i.x, n.x, o.x); var s = Math.max(t.x, i.x, n.x, o.x); var a = Math.min(t.y, i.y, n.y, o.y); var l = Math.max(t.y, i.y, n.y, o.y); return new e.Rect(r, a, s - r, l - a) },
        getIntegerBoundingBox: function () { var t = this.getBoundingBox(); var i = Math.floor(t.x); var n = Math.floor(t.y); var o = Math.ceil(t.width + t.x - i); var r = Math.ceil(t.height + t.y - n); return new e.Rect(i, n, o, r) },
...
! function (e) {
    ...
    e.ReferenceStrip = function (h) {
        ...
        this.viewer = p;
        this.innerTracker = new e.MouseTracker({ element: this.element, dragHandler: e.delegate(this, i), scrollHandler: e.delegate(this, n), enterHandler: e.delegate(this, r), exitHandler: e.delegate(this, s), keyDownHandler: e.delegate(this, a), keyHandler: e.delegate(this, l) });
        if (h.width && h.height) {
        ...
        for (d = 0; d < p.tileSources.length; d++) {
            ...
            c.innerTracker = new e.MouseTracker({
                ...
                clickTimeThreshold: this.clickTimeThreshold,
                clickDistThreshold: this.clickDistThreshold,
                pressHandler: function (t) { t.eventSource.dragging = e.now() },
                releaseHandler: function (t) {
                    var i = t.eventSource,
                        n = i.element.id,
                        o = Number(n.split("-")[2]),
    ...
    e.extend(e.ReferenceStrip.prototype, e.EventSource.prototype, e.Viewer.prototype, {
        ...
        update: function () { if (t[this.id].animating) { e.console.log("image reference strip update"); return !0 } return !1 },
        destroy: function () {
            if (this.miniViewers)
...
! function (e) {
    e.Spring = function (t) {
        var i = arguments;
        "object" != typeof t && (t = { initial: i.length && "number" == typeof i[0] ? i[0] : void 0, springStiffness: i.length > 1 ? i[1].springStiffness : 5, animationTime: i.length > 1 ? i[1].animationTime : 1.5 });
        ...
        start: function () {
            ...
            if (this.loadWithAjax) {
                this.request = e.makeAjaxRequest({
                    ...
                    success: function (e) {
                        var i;
                        try { i = new window.Blob([e.response]) } catch (t) {
                ...
                this.abort = function () { t.request.abort(); "function" == typeof i && i() }
            } else {
    ...
    e.Tile.prototype = {
        ...
        getScaleForEdgeSmoothing: function () {
            ...
            if (this.cacheImageRecord) t = this.cacheImageRecord.getRenderedContext();
                ...
                if (!this.context2D) { e.console.warn("[Tile.drawCanvas] attempting to get tile scale %s when tile's not cached", this.toString()); return 1 }
                t = this.context2D
            }
            return t.canvas.width / (this.size.x * e.pixelDensityRatio)
        },
        getTranslationForEdgeSmoothing: function (t, i, n) { var o = Math.max(1, Math.ceil((n.x - i.x) / 2)); var r = Math.max(1, Math.ceil((n.y - i.y) / 2)); return new e.Point(o, r).minus(this.position.times(e.pixelDensityRatio).times(t || 1).apply(function (e) { return e % 1 })) },
        unload: function () {
...
! function (e) {
    ...
    e.Overlay.prototype = {
        ...
        _adjustBoundsForRotation: function (t, i) { if (!t || 0 === t.degrees || this.rotationMode === e.OverlayRotationMode.EXACT) return i; if (this.rotationMode === e.OverlayRotationMode.BOUNDING_BOX) { if (null === this.width || null === this.height) return i; var n = this._getOverlayPositionAndSize(t); return t.viewerElementToViewportRectangle(new e.Rect(n.position.x, n.position.y, n.size.x, n.size.y)) } return i.rotate(-t.degrees, this._getPlacementPoint(i)) }
    }
}(OpenSeadragon);
! function (e) {
    e.Drawer = function (t) {
    ...
    e.Drawer.prototype = {
        ...
        setOpacity: function (t) { e.console.error("drawer.setOpacity is deprecated. Use tiledImage.setOpacity instead."); var i = this.viewer.world; for (var n = 0; n < i.getItemCount(); n++) i.getItemAt(n).setOpacity(t); return this },
        getOpacity: function () {
        ...
        needsUpdate: function () { e.console.error("[Drawer.needsUpdate] this function is deprecated. Use World.needsDraw instead."); return this.viewer.world.needsDraw() },
        numTilesLoaded: function () { e.console.error("[Drawer.numTilesLoaded] this function is deprecated. Use TileCache.numTilesLoaded instead."); return this.viewer.tileCache.numTilesLoaded() },
        reset: function () {
        ...
        viewportToDrawerRectangle: function (t) { var i = this.viewport.pixelFromPointNoRotate(t.getTopLeft(), !0); var n = this.viewport.deltaPixelsFromPointsNoRotate(t.getSize(), !0); return new e.Rect(i.x * e.pixelDensityRatio, i.y * e.pixelDensityRatio, n.x * e.pixelDensityRatio, n.y * e.pixelDensityRatio) },
        ...
        getCanvasSize: function (t) { var i = this._getContext(t).canvas; return new e.Point(i.width, i.height) },
        getCanvasCenter: function () { return new e.Point(this.canvas.width / 2, this.canvas.height / 2) },
        ...
        _calculateCanvasSize: function () { var t = e.pixelDensityRatio; var i = this.viewport.getContainerSize(); return { x: i.x * t, y: i.y * t } },
...
! function (e) {
    ...
    e.Viewport.prototype = {
        ...
        _setContentBounds: function (t, i) {
            ...
            this.viewer && this.viewer.raiseEvent("reset-size", { contentSize: this._contentSizeNoRotate.clone(), contentFactor: i, homeBounds: this._contentBoundsNoRotate.clone(), contentBounds: this._contentBounds.clone() })
        },
        getHomeZoom: function () { if (this.defaultZoomLevel) return this.defaultZoomLevel; var e = this._contentAspectRatio / this.getAspectRatio(); return (this.homeFillsViewer ? e >= 1 ? e : 1 : e >= 1 ? 1 : e) / this._contentBounds.width },
        getHomeBounds: function () { return this.getHomeBoundsNoRotate().rotate(-this.getRotation()) },
        getHomeBoundsNoRotate: function () { var t = this._contentBounds.getCenter(); var i = 1 / this.getHomeZoom(); var n = i / this.getAspectRatio(); return new e.Rect(t.x - i / 2, t.y - n / 2, i, n) },
        ...
        getContainerSize: function () { return new e.Point(this.containerSize.x, this.containerSize.y) },
        getMargins: function () { return e.extend({}, this._margins) },
        ...
        getBoundsNoRotate: function (t) { var i = this.getCenter(t); var n = 1 / this.getZoom(t); var o = n / this.getAspectRatio(); return new e.Rect(i.x - n / 2, i.y - o / 2, n, o) },
        ...
        _fitBounds: function (t, i) {
            ...
            if (n) { this.panTo(s, !0); return this.zoomTo(l, null, !0) }
            this.panTo(this.getCenter(!0), !0);
            this.zoomTo(this.getZoom(!0), null, !0);
            var u = this.getBounds();
            var d = this.getZoom();
            if (0 === d || Math.abs(l / d - 1) < 1e-8) { this.zoomTo(l, !0); return this.panTo(s, n) }
        ...
        fitVertically: function (t) { var i = new e.Rect(this._contentBounds.x + this._contentBounds.width / 2, this._contentBounds.y, 0, this._contentBounds.height); return this.fitBounds(i, t) },
        fitHorizontally: function (t) { var i = new e.Rect(this._contentBounds.x, this._contentBounds.y + this._contentBounds.height / 2, this._contentBounds.width, 0); return this.fitBounds(i, t) },
        getConstrainedBounds: function (e) {
            var t;
            t = this.getBounds(e);
            return this._applyBoundaryConstraints(t)
        },
        panBy: function (t, i) { var n = new e.Point(this.centerSpringX.target.value, this.centerSpringY.target.value); return this.panTo(n.plus(t), i) },
        panTo: function (e, t) {
            if (t) {
        ...
        _updateContainerInnerSize: function () { this._containerInnerSize = new e.Point(Math.max(1, this.containerSize.x - (this._margins.left + this._margins.right)), Math.max(1, this.containerSize.y - (this._margins.top + this._margins.bottom))) },
        update: function () {
            var e = this;
        ...
        _pixelFromPointNoRotate: function (t, i) { return t.minus(i.getTopLeft()).times(this._containerInnerSize.x / i.width).plus(new e.Point(this._margins.left, this._margins.top)) },
        _pixelFromPoint: function (e, t) { return this._pixelFromPointNoRotate(e.rotate(this.getRotation(), this.getCenter(!0)), t) },
        pointFromPixelNoRotate: function (t, i) { var n = this.getBoundsNoRotate(i); return t.minus(new e.Point(this._margins.left, this._margins.top)).divide(this._containerInnerSize.x / n.width).plus(n.getTopLeft()) },
        pointFromPixel: function (e, t) { return this.pointFromPixelNoRotate(e, t).rotate(-this.getRotation(), this.getCenter(!0)) },
        _viewportToImageDelta: function (t, i) { var n = this._contentBoundsNoRotate.width; return new e.Point(t * this._contentSizeNoRotate.x / n, i * this._contentSizeNoRotate.x / n) },
        viewportToImageCoordinates: function (t, i) {
            ...
            if (this.viewer) {
                ...
                else if (1 === n) { return this.viewer.world.getItemAt(0).viewportToImageCoordinates(t, i, !0) }
            }
            return this._viewportToImageDelta(t - this._contentBoundsNoRotate.x, i - this._contentBoundsNoRotate.y)
        },
        _imageToViewportDelta: function (t, i) { var n = this._contentBoundsNoRotate.width; return new e.Point(t / this._contentSizeNoRotate.x * n, i / this._contentSizeNoRotate.x * n) },
        imageToViewportCoordinates: function (t, i) {
            ...
            if (this.viewer) {
                ...
                else if (1 === n) { return this.viewer.world.getItemAt(0).imageToViewportCoordinates(t, i, !0) }
            }
        ...
        imageToViewportRectangle: function (t, i, n, o) {
            ...
            if (this.viewer) {
                ...
                else if (1 === s) { return this.viewer.world.getItemAt(0).imageToViewportRectangle(t, i, n, o, !0) }
            }
        ...
        viewportToImageRectangle: function (t, i, n, o) {
            ...
            if (this.viewer) {
                ...
                else if (1 === s) { return this.viewer.world.getItemAt(0).viewportToImageRectangle(t, i, n, o, !0) }
            }
        ...
        windowToImageCoordinates: function (t) { e.console.assert(this.viewer, "[Viewport.windowToImageCoordinates] the viewport must have a viewer."); var i = t.minus(e.getElementPosition(this.viewer.element)); return this.viewerElementToImageCoordinates(i) },
        imageToWindowCoordinates: function (t) { e.console.assert(this.viewer, "[Viewport.imageToWindowCoordinates] the viewport must have a viewer."); return this.imageToViewerElementCoordinates(t).plus(e.getElementPosition(this.viewer.element)) },
        ...
        viewerElementToViewportRectangle: function (t) { return e.Rect.fromSummits(this.pointFromPixel(t.getTopLeft(), !0), this.pointFromPixel(t.getTopRight(), !0), this.pointFromPixel(t.getBottomLeft(), !0)) },
        viewportToViewerElementRectangle: function (t) { return e.Rect.fromSummits(this.pixelFromPoint(t.getTopLeft(), !0), this.pixelFromPoint(t.getTopRight(), !0), this.pixelFromPoint(t.getBottomLeft(), !0)) },
        windowToViewportCoordinates: function (t) { e.console.assert(this.viewer, "[Viewport.windowToViewportCoordinates] the viewport must have a viewer."); var i = t.minus(e.getElementPosition(this.viewer.element)); return this.viewerElementToViewportCoordinates(i) },
        viewportToWindowCoordinates: function (t) { e.console.assert(this.viewer, "[Viewport.viewportToWindowCoordinates] the viewport must have a viewer."); return this.viewportToViewerElementCoordinates(t).plus(e.getElementPosition(this.viewer.element)) },
        viewportToImageZoom: function (t) {
            if (this.viewer) {
                ...
                else if (1 === i) { return this.viewer.world.getItemAt(0).viewportToImageZoom(t) }
            }
        ...
        imageToViewportZoom: function (t) {
            if (this.viewer) {
                ...
                else if (1 === i) { return this.viewer.world.getItemAt(0).imageToViewportZoom(t) }
            }
...
! function (e) {
    ...
    e.extend(e.TiledImage.prototype, e.EventSource.prototype, {
        ...
        getBoundsNoRotate: function (t) { return t ? new e.Rect(this._xSpring.current.value, this._ySpring.current.value, this._worldWidthCurrent, this._worldHeightCurrent) : new e.Rect(this._xSpring.target.value, this._ySpring.target.value, this._worldWidthTarget, this._worldHeightTarget) },
        getWorldBounds: function () { e.console.error("[TiledImage.getWorldBounds] is deprecated; use TiledImage.getBounds instead"); return this.getBounds() },
        ...
        getContentSize: function () { return new e.Point(this.source.dimensions.x, this.source.dimensions.y) },
        _viewportToImageDelta: function (t, i, n) { var o = n ? this._scaleSpring.current.value : this._scaleSpring.target.value; return new e.Point(t * (this.source.dimensions.x / o), i * (this.source.dimensions.y * this.contentAspectX / o)) },
        ...
        _imageToViewportDelta: function (t, i, n) { var o = n ? this._scaleSpring.current.value : this._scaleSpring.target.value; return new e.Point(t / this.source.dimensions.x * o, i / this.source.dimensions.y / this.contentAspectX * o) },
        ...
        _updateViewport: function () {
            ...
            for (; this.lastDrawn.length > 0;) { this.lastDrawn.pop().beingDrawn = !1 }
            var i = this.viewport;
            var r = this._viewportToTiledImageRectangle(i.getBoundsWithMargins(!0));
            if (!this.wrapHorizontal && !this.wrapVertical) { var s = this._viewportToTiledImageRectangle(this.getClippedBounds(!0)); if (null === (r = r.intersection(s))) return }
            ...
            for (var p = h; p >= l; p--) {
                ...
                if (!r) {
                    0 !== t.viewport.degrees ? t._drawer._offsetForRotation({ degrees: t.viewport.degrees, useSketch: o }) : t._drawer.viewer.viewport.flipped && t._drawer._flip({});
                    t.getRotation(!0) % 360 != 0 && t._drawer._offsetForRotation({ degrees: t.getRotation(!0), point: t.viewport.pixelFromPointNoRotate(t._getRotationPoint(!0), !0), useSketch: o })
                }
                var c = !1;
                if (t._clip) {
                ...
                if (o) {
                    if (r) {
                        0 !== t.viewport.degrees && t._drawer._offsetForRotation({ degrees: t.viewport.degrees, useSketch: !1 });
                        t.getRotation(!0) % 360 != 0 && t._drawer._offsetForRotation({ degrees: t.getRotation(!0), point: t.viewport.pixelFromPointNoRotate(t._getRotationPoint(!0), !0), useSketch: !1 })
                    }
                    t._drawer.blendSketch({ opacity: t.opacity, scale: r, translate: s, compositeOperation: t.compositeOperation, bounds: h });
                    if (r) {
                    ...
                    if (t.debugMode)
                        for (var n = i.length - 1; n >= 0; n--) { var o = i[n]; try { t._drawer.drawDebugInfo(o, i.length, n, t) } catch (t) { e.console.error(t) } }
                }(t, i)
            }(this, this.lastDrawn);
            if (c && !c.context2D) {
                ! function (t, i, o) {
    ...
    function t(e, t, n, o, r, s, l, h, c) {
        ...
        for (var w = g.x; w <= m.x; w++)
            for (var y = g.y; y <= m.y; y++) {
                if (!e.wrapHorizontal && !e.wrapVertical) { var T = e.source.getTileBounds(o, w, y); if (null === l.intersection(T)) continue }
    ...
    function i(t, i, o, a, l, h, c, u, d, p, g, m) {
        ...
        if (!v.loaded)
            ...
            else { var y = t._tileCache.getImageRecord(v.cacheKey); if (y) { n(t, v, y.getImage()) } }
        if (v.loaded) {
        ...
        } else v.loading ? t._tilesLoading++ : w || (m = function (e, t) { if (!e) return t; { if (t.visibility > e.visibility) return t; if (t.visibility == e.visibility && t.squaredDistance < e.squaredDistance) return t } return e }(m, v));
        return m
    }
...
! function (e) {
    ...
    t.prototype = {
        ...
        removeTile: function (t) {
            for (var i = 0; i < this._tiles.length; i++)
                if (this._tiles[i] === t) { this._tiles.splice(i, 1); return }
    ...
    e.TileCache.prototype = {
        ...
        getImageRecord: function (t) { e.console.assert(t, "[TileCache.getImageRecord] cacheKey is required"); return this._imagesLoaded[t] },
...
! function (e) {
    ...
    e.extend(e.World.prototype, e.EventSource.prototype, {
        ...
        getItemAt: function (t) { e.console.assert(void 0 !== t, "[World.getItemAt] index is required"); return this._items[t] },
        getIndexOfItem: function (t) { e.console.assert(t, "[World.getIndexOfItem] item is required"); return e.indexOf(this._items, t) },
